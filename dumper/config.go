...
type Options struct {
	...
	Partitioning   tengo.PartitioningMode   // PartitioningKeep: retain FS partitioning clause if DB is unpartitioned; PartitioningRemove: ignore DB partitioning clause
